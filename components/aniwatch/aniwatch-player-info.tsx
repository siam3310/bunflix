  ...
  return (
    <div className="flex flex-col pb-24 p-4 bg-black/30 rounded-lg xl:flex-row gap-4 justify-between">
      ...
      <div className="w-full ">
        <h1 className="py-2 pt-4 text-3xl font-semibold">{data.anime.info.name}</h1>
      ...
      <div className="w-full">
        ...
        <div className="flex items-center mb-6">
          <ul 
          className=" max-h-[500px] w-full bg-slate-500 overflow-y-scroll rounded-lg scrollbar-hide">
